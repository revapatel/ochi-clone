...
function Foot() {
  return (
    ...
    <div data-scroll data-scroll-section data-scroll-speed="0.1"  className="w-full foot h-[100vh] bg-zinc-900">


<div className="w-full flex px-20 py-10 h-[92vh]">
<h1 className='font-main leading-[7vw] text-[8vw]'>EYE- <br />
OPENING</h1>
<div className="">
    <h1 className='ml-[25vw]  font-main leading-[7vw] text-[8vw]'>PRESENTATIONS</h1>
    <div className="flex ml-[25vw] mt-10">
        <div className="font-[Neue_Montreal]">
            <h1>S :)</h1>
            <li  className=' mt-5 font-["Neue Montreal"]'> Instagram</li>
            <li className=''>Behance</li>
            <li className=''>Facebook</li>
            <li className=''>Linkedin</li>
            <h1 className='mt-5'>L :)</h1>
            <li className=' mt-5'> 202-1965 W 4th Ave</li>
            <li className=''>Vancouver, Canada</li>
            <li className=' mt-5'>30 Chukarina St</li>
            <li className=''>LinkedinLviv, Ukraine</li>
            <h1 className='mt-5 '>E :)</h1>
            <li className=' mt-5'> hello@reva.com</li>

            
        </div>
        <div className="ml-[14vw] mt-[8vw]">
...
<div className="w-full px-20 flex  justify-between border-t-[1px] items-center h-[8vh]">
    <div className="logo">
          <svg className='text-zinc-200'
            width="72"
            height="30"
            viewBox="0 0 72 30"
            fill="none"
