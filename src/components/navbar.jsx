...
function Navbar() {
  return (
    <>
      <div className="navbar  fixed z-[99999] w-full px-20 py-5 font-['Neue Montreal'] flex justify-between items-center bg-[rgba(24,24,26,0.9)]">
        <div className="logo">
          <svg
            width="72"
            height="30"
        ...
        <div className="links flex gap-10">
          {["Services", "Our work", "About us", "Insigts", "Contact us"].map(
            (data, index) => (
              <Link
                to="/"
                key={index}
