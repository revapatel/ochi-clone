...
import img9 from "../assets/img/logo003.png";
function Normalcard() {
  return (
   <>
   
   
   <div     className="w-full  h-[100vh] px-20 flex bg-[#F1F1F1] items-center justify-center gap-5">


<div class="h-[60vh] w-[50vw]   rounded-[15px] relative   bg-[#004D43] text-green-100  ">
				<div class="absolute left-0 top-0 w-full h-full flex items-center justify-center p-20">
        <div className="logo ">
          <svg className="text-[#CDEA68]"
            width="10vw"
            height="90"
            viewBox="0 0 72 30"
            fill="none"
          ...
          >
            ...
            ></path>
				...
				<div className="btn bottom-8 left-12 absolute border border-zinc-100 px-4 py-1 rounded-[20px]  "><button>©2024–2025</button></div>
				
						</div>
<div class="h-[60vh] w-[25vw]   rounded-[15px] relative  pointer-events-none bg-[#212121] text-green-100  ">
				<div class="absolute left-0 top-0 w-full h-full flex items-center justify-center p-20">
        <h1 className=" font-main-nice text-[50vw]] font-[5vw]  text-zinc-300">clutch</h1>
				</div>
        <div className="btn bottom-8 left-12 absolute border border-zinc-100 px-4 py-1 rounded-[20px]  "><button>©2024–2025</button></div>
